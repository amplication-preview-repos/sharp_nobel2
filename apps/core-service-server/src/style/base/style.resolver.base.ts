...
import { CreateStyleArgs } from "./CreateStyleArgs";
import { UpdateStyleArgs } from "./UpdateStyleArgs";
...
export class StyleResolverBase {
  ...
  async createStyle(@graphql.Args() args: CreateStyleArgs): Promise<Style> {
  ...
  @graphql.Mutation(() => Style)
  async updateStyle(
    @graphql.Args() args: UpdateStyleArgs
  ): Promise<Style | null> {
    try {
